  ...
  return (
    <main className="flex-1 p-8 min-w-0">
      ...
      <div className="flex gap-3 mb-6">
        <div className="h-9 flex-1 max-w-sm rounded-lg bg-slate-200 animate-pulse" />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-4 items-start">
        ...
        <div className="lg:col-span-3 h-96 rounded-xl border border-dashed border-slate-300 bg-white/60 animate-pulse" />
      </div>
    </main>
  );
}
